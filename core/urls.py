...
urlpatterns = [
    ...
    # CORE & USUARIOS (Cambiado uuid -> int)
    ...
    path('cliente/fiscal/<int:cliente_id>/', views.guardar_datos_fiscales, name='guardar_datos_fiscales'), # SAT
    ...
    # DRIVE & ARCHIVOS (Cambiado uuid -> int)
    ...
    # CONTRATOS & PLANTILLAS (Cambiado uuid -> int)
    ...
    path('cotizaciones/<int:cotizacion_id>/email/', views.enviar_cotizacion_email, name='enviar_cotizacion_email'),
    path('cotizaciones/<int:cotizacion_id>/convertir/', views.convertir_a_cliente, name='convertir_a_cliente'),
    ...
    # FINANZAS & CONTABILIDAD (Cambiado uuid -> int)
    ...
    path('finanzas/cuenta/<int:cuenta_id>/pagar/', views.registrar_pago, name='registrar_pago'), # Ajustado si faltaba
    path('finanzas/pagar/', views.registrar_pago, name='registrar_pago'), # Backup por si se usa directo
